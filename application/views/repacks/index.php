...
<div class="intro">
    ...
    <?php if (authprofiles::is_logged_in() && 
        ...
        <!-- <br/>
        <a href=""><?=_('View Firefox customizations')?></a>
        <a href="<?=url::site("profiles/{$profile->screen_name}/mailclients")?>"><?=_('View Thunderbird customizations')?></a>
	-->
	<span class="button large blue"><a href="<?=url::site("profiles/{$profile->screen_name}/mailclients")?>"><?=_('View Thunderbird customizations')?></a></span>
        </form>
