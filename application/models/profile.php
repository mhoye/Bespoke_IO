...
class Profile_Model extends Auth_Profile_Model
{
    ...
    public function validate_registration(&$data)
    {
        ...
        $data = Validation::factory($data)
            ...
            ->add_rules('admin', 'required', 'length[3,64]', 
                'valid::alpha_dash', array($login_model, 'is_login_name_registered'))
            ->add_rules('admin_pwd', 'length[6,255]', 'required')
            ->add_callbacks('admin_pwd', array($login_model, 'is_password_correct'))
            ;
