...
$config['profiles/([^/]+)/mailclients/([^/]+)/?([^/]*)/firstrun'] =  
    'thunderbird_repacks/firstrun/screen_name/$1/short_name/$2/status/$3';
$config['profiles/([^/]+)/mailclients/([^/]+)/?([^/]*)/repack.log'] =
    'thunderbird_repacks/repacklog/screen_name/$1/short_name/$2/status/$3';
$config['profiles/([^/]+)/mailclients/([^/]+)/?([^/]*)/repack.cfg'] =
    'thunderbird_repacks/repackcfg/screen_name/$1/short_name/$2/status/$3';
$config['profiles/([^/]+)/mailclients/([^/]+)/?([^/]*)/distribution.ini'] =
    'thunderbird_repacks/distributionini/screen_name/$1/short_name/$2/status/$3';
$config['profiles/([^/]+)/mailclients/([^/]+)/?([^/]*)/repack.json'] =
    'thunderbird_repacks/repackjson/screen_name/$1/short_name/$2/status/$3';
$config['profiles/([^/]+)/mailclients/([^/]+)/?([^/]*)/downloads/(.*)'] =  
    'thunderbird_repacks/download/screen_name/$1/short_name/$2/status/$3/filename/$4';


$config['profiles/([^/]+)/mailclients/'] =                  
    'thunderbird_repacks/index/screen_name/$1';

$config['profiles/([^/]+)/mailclients/([^/]+)/?([^/]*)/downloads/(.*)'] =  
    'thunderbird_repacks/download/screen_name/$1/short_name/$2/status/$3/filename/$4';

$config['profiles/([^/]+)/mailclients/([^;/]+)/?([^;]*);(.*)'] =
    'thunderbird_repacks/$4/screen_name/$1/short_name/$2/status/$3';
$config['profiles/([^/]+)/mailclients/([^/]+)/?(.*)'] =              
    'thunderbird_repacks/view/screen_name/$1/short_name/$2/status/$3';
