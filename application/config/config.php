...
$config['contact_URL'] = 'http://bespokeio.com/contact/';
...
(
    ...
    APPPATH.'modules/certificate_management',
    APPPATH.'modules/general',
    APPPATH.'modules/thunderbird_general',
    APPPATH.'modules/thunderbird_security',
    APPPATH.'modules/thunderbird_ntlm',
    APPPATH.'modules/thunderbird_addons',
    APPPATH.'modules/thunderbird_lightning',
    APPPATH.'modules/thunderbird_chat',
);
