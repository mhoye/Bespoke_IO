...
class Mozilla_BYOB_Editor_GeneralSpecs extends Mozilla_BYOB_Editor {

    /** {{{ Object properties */
    public $id = 'general';
    public $title = 'General';
    public $view_name = 'repacks/edit/edit_general_specs';
    public $review_view_name = 'repacks/edit/review_general_specs';
    ...
    {
       return $repack->checkPrivilege('general_specs'); 
    }   
