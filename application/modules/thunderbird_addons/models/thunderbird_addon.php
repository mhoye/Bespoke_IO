 ...
 */
class Thunderbird_Addon_Model extends Model
{
    // {{{ Object properties
    ...
    public function __construct()
    {
        ...
        $this->_known = 
            Kohana::config('thunderbird_addons.addons');
        $this->_base_dir = 
            Kohana::config('thunderbird_addons.dir');
        $this->_api_url = 
            Kohana::config('thunderbird_addons.api_url');
        $this->_c_api_url = 
            Kohana::config('thunderbird_addons.collections_api_url');
        $this->_c_api_user = 
            Kohana::config('thunderbird_addons.collections_username');
        $this->_c_api_pass = 
            Kohana::config('thunderbird_addons.collections_password');
    }
