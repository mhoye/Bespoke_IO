    ...
    function _getDownloadBlockListHtmlForLocaleAndPlatform($locale, $platform, $options=array()) {
            ...
            switch ($_layout) {
                case 'subpage':
                    ...
                    $_return = <<<LI_SIDEBAR
                    <li class="{$_os_class}">
                        <a class="download-link download-{$_product}" onclick="init_download('{$this->download_base_url_direct}?product={$_product}-{$_current_version}&amp;os={$_os_shortname}&amp;lang={$locale}');" href="{$_download_base_url}?product={$_product}-{$_current_version}&amp;os={$_os_shortname}&amp;lang={$locale}" {$_extra_link_attr}><span class="download-content">
